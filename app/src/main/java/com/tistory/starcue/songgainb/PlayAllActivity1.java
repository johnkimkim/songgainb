...
public class PlayAllActivity1 extends AppCompatActivity{
...
//        url = intent.getStringExtra("urlField");
        ...
        youTubePlayerView.addYouTubePlayerListener(new AbstractYouTubePlayerListener() {
            ...
            public void onReady(@NotNull com.pierfrancescosoffritti.androidyoutubeplayer.core.player.YouTubePlayer youTubePlayer) {
                DatabaseHandler databaseHandler = new DatabaseHandler(PlayAllActivity1.this);
            ...
            public void onStateChange(@NotNull final com.pierfrancescosoffritti.androidyoutubeplayer.core.player.YouTubePlayer youTubePlayer, @NotNull final PlayerConstants.PlayerState state) {
                if (state == PlayerConstants.PlayerState.ENDED) {
                    Intent intent = new Intent(PlayAllActivity1.this, PlayAllActivity.class);
...
//        initializeYoutubePlayer();
    ...
    private void initializeYoutubePlayer() {
        ...
        databaseHandler = new DatabaseHandler(PlayAllActivity1.this);
...
//    };
    ...
    public void onBackPressed() {
        Intent intent = new Intent(PlayAllActivity1.this, MainActivity.class);
        startActivity(intent);
        overridePendingTransition(0,0);
        super.onBackPressed();
    }
